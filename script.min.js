document.addEventListener('DOMContentLoaded', function() {
    ...
    if (mediaItems.length > 0) {
        ...
        // Preload videos to ensure they're ready to play
        ...
        const showMedia = (index) => {
            ...
            if (video) {
                ...
                video.play().catch(e => {
                    ...
                    video.load();
                    setTimeout(() => {
                        video.play().catch(e2 => console.log('Second attempt video play error:', e2));
                    }, 100);
                });
            }
    ...
    if (sliderTrack && sliderDots.length > 0) {
        ...
        // Set up automatic rotation for the slider
    ...
    // Video Showcase Section - Ensure videos load properly
